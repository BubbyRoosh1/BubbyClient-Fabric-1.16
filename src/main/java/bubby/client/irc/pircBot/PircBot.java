...
public abstract class PircBot implements ReplyConstants
{
  ...
  private final ArrayList<IrcLine> lines = new ArrayList<IrcLine>();
  // Connection stuff.
  ...
  protected void handleLine(String line)
  {
    ...
    if(senderInfo.startsWith(":"))
    {
      if(exclamation > 0 && at > 0 && exclamation < at)
      {
        ...
        //
        String separ = "PRIVMSG #bubbyclientircpog :";
        if(line.contains(separ))
        {
          ...
          if(chatIndx > 0)
          {
            ...
            lines.add(new IrcLine(chatLine++, chatMessage, sourceNick, false));
            messagesAwaiting = true;
          }
        }
        //
      }
  ...
  {
    return ((increment) ? (chatLine = chatLine++) : chatLine);
  }
  ...
  public ArrayList<IrcLine> getUnreadLines()
  {
    ...
    messagesAwaiting = false;
    return ret;
  }

  public boolean newMessages()
  {
    return messagesAwaiting;
  }
}
